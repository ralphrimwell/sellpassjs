...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SellPassWebApi.FaqDetails();
  });
  ...
  describe('FaqDetails', function() {
    it('should create an instance of FaqDetails', function() {
      // uncomment below and update the code to test FaqDetails
      //var instance = new SellPassWebApi.FaqDetails();
      //expect(instance).to.be.a(SellPassWebApi.FaqDetails);
    });
