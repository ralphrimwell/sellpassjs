...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SellPassWebApi.ResetPasswordRequest();
  });
  ...
  describe('ResetPasswordRequest', function() {
    it('should create an instance of ResetPasswordRequest', function() {
      ...
      //var instance = new SellPassWebApi.ResetPasswordRequest();
      //expect(instance).to.be.a(SellPassWebApi.ResetPasswordRequest);
    });
