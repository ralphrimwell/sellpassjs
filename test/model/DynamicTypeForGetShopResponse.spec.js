...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SellPassWebApi.DynamicTypeForGetShopResponse();
  });
  ...
  describe('DynamicTypeForGetShopResponse', function() {
    it('should create an instance of DynamicTypeForGetShopResponse', function() {
      // uncomment below and update the code to test DynamicTypeForGetShopResponse
      //var instance = new SellPassWebApi.DynamicTypeForGetShopResponse();
      //expect(instance).to.be.a(SellPassWebApi.DynamicTypeForGetShopResponse);
    });
