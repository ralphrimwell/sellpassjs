...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SellPassWebApi.ChangeShopDesignRequest();
  });
  ...
  describe('ChangeShopDesignRequest', function() {
    it('should create an instance of ChangeShopDesignRequest', function() {
      // uncomment below and update the code to test ChangeShopDesignRequest
      //var instance = new SellPassWebApi.ChangeShopDesignRequest();
      //expect(instance).to.be.a(SellPassWebApi.ChangeShopDesignRequest);
    });
