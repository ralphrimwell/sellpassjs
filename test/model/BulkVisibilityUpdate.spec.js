...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SellPassWebApi.BulkVisibilityUpdate();
  });
  ...
  describe('BulkVisibilityUpdate', function() {
    it('should create an instance of BulkVisibilityUpdate', function() {
      // uncomment below and update the code to test BulkVisibilityUpdate
      //var instance = new SellPassWebApi.BulkVisibilityUpdate();
      //expect(instance).to.be.a(SellPassWebApi.BulkVisibilityUpdate);
    });
