...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SellPassWebApi.ServiceTypeForGetShopResponse();
  });
  ...
  describe('ServiceTypeForGetShopResponse', function() {
    it('should create an instance of ServiceTypeForGetShopResponse', function() {
      // uncomment below and update the code to test ServiceTypeForGetShopResponse
      //var instance = new SellPassWebApi.ServiceTypeForGetShopResponse();
      //expect(instance).to.be.a(SellPassWebApi.ServiceTypeForGetShopResponse);
    });
