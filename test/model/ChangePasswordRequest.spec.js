...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SellPassWebApi.ChangePasswordRequest();
  });
  ...
  describe('ChangePasswordRequest', function() {
    it('should create an instance of ChangePasswordRequest', function() {
      ...
      //var instance = new SellPassWebApi.ChangePasswordRequest();
      //expect(instance).to.be.a(SellPassWebApi.ChangePasswordRequest);
    });
