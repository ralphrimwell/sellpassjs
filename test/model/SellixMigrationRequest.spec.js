...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SellPassWebApi.SellixMigrationRequest();
  });
  ...
  describe('SellixMigrationRequest', function() {
    it('should create an instance of SellixMigrationRequest', function() {
      // uncomment below and update the code to test SellixMigrationRequest
      //var instance = new SellPassWebApi.SellixMigrationRequest();
      //expect(instance).to.be.a(SellPassWebApi.SellixMigrationRequest);
    });
