...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SellPassWebApi.CreateAnnouncementRequest();
  });
  ...
  describe('CreateAnnouncementRequest', function() {
    it('should create an instance of CreateAnnouncementRequest', function() {
      // uncomment below and update the code to test CreateAnnouncementRequest
      //var instance = new SellPassWebApi.CreateAnnouncementRequest();
      //expect(instance).to.be.a(SellPassWebApi.CreateAnnouncementRequest);
    });
