...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SellPassWebApi.SerialsTypeForGetShopResponse();
  });
  ...
  describe('SerialsTypeForGetShopResponse', function() {
    it('should create an instance of SerialsTypeForGetShopResponse', function() {
      // uncomment below and update the code to test SerialsTypeForGetShopResponse
      //var instance = new SellPassWebApi.SerialsTypeForGetShopResponse();
      //expect(instance).to.be.a(SellPassWebApi.SerialsTypeForGetShopResponse);
    });
