...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SellPassWebApi.DynamicType();
  });
  ...
  describe('DynamicType', function() {
    it('should create an instance of DynamicType', function() {
      // uncomment below and update the code to test DynamicType
      //var instance = new SellPassWebApi.DynamicType();
      //expect(instance).to.be.a(SellPassWebApi.DynamicType);
    });
