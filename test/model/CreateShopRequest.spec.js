...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SellPassWebApi.CreateShopRequest();
  });
  ...
  describe('CreateShopRequest', function() {
    it('should create an instance of CreateShopRequest', function() {
      ...
      //var instance = new SellPassWebApi.CreateShopRequest();
      //expect(instance).to.be.a(SellPassWebApi.CreateShopRequest);
    });
