...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SellPassWebApi.CreateTicketRequest();
  });
  ...
  describe('CreateTicketRequest', function() {
    it('should create an instance of CreateTicketRequest', function() {
      ...
      //var instance = new SellPassWebApi.CreateTicketRequest();
      //expect(instance).to.be.a(SellPassWebApi.CreateTicketRequest);
    });
